...
pipx install ./temple_guard-0.3.3-py3-none-any.whl
```
...
pipx install .\temple_guard-0.3.3-py3-none-any.whl
```
...
./temple_guard-0.3.3-py3-none-any.whl` works too (ideally inside a virtualenv).
